  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Text("TUĞÇE GÖKÇEOĞLU",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25,color: Color(0xFFfefeff),shadows: [
              Shadow(
                blurRadius:15,
          ...
          Padding(
            ...
            style: TextStyle(letterSpacing: 1.5,height: 1.5,color: Color(0xFFfefeff)),textAlign: TextAlign.center,)),
          SizedBox(height: 16,),
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 50),
            child: Text(widget.trlang == true ? "Aşağıdaki Sosyal Medya İconlarına Tıklayarak Bana Ulaşabilirsiniz." : "You can reach me by clicking on the Social Media Icons below.",style: TextStyle(letterSpacing: 1.5,height: 1.5,color:Color(0xFFfefeff)),textAlign: TextAlign.center,),
          ),
          SizedBox(height: 16,),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: [
              ...
              constraints: BoxConstraints(),
              onPressed: (){
                _launchUri("https://www.linkedin.com/in/tgcegkceoglu/");
              }, 
              ...
              constraints: BoxConstraints(),
              onPressed: (){
                _launchUri("https://github.com/tgcegkceoglu");
              }, 
