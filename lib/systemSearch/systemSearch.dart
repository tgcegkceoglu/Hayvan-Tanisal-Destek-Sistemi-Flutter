...
class _SystemSearchState extends State<SystemSearch> {
  ...
  void initState() {
    ...
    context
        .read<SystemCubit>()
        .systemJsonRead(list, widget.system, widget.trlang);
    _start();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintText: widget.trlang == true
                ? "Belirtileri/Semptomları Arayın..."
      ...
      body: Column(
        children: [
          Expanded(child: BlocBuilder<SystemCubit, List<String>>(
